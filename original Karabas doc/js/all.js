...
/*js/drexplain/nav-tree/views/navTree.item-decoration.view.js*/
	window.NavTree__ItemDecoration_View = 
	{
		...
		html_expander_doClose: '<span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="�" title="" src="img/i/null.gif" /></span>',
		html_expander_doOpen: '<span class="b-tree__i_expander_doOpen"><img class="b-tree__i_expander_doOpen_inner" alt="+" title="" src="img/i/null.gif" /></span>',
		...
		html_render_folder_expander_angle_tl_cached: '<span class="b-tree__spacer"><span class="b-tree__i_angle_tl"><span class="b-tree__i_angle_tl_inner"></span></span><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="img/i/null.gif" /></span></span>',
		html_render_folder_expander_hline_mr_cached: '<span class="b-tree__spacer"><span class="b-tree__i_hLine_mr"><span class="b-tree__i_hLine_mr_inner"></span></span><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="img/i/null.gif" /></span></span>',
		html_render_folder_expander_angle_bl_cached: '<span class="b-tree__spacer"><span class="b-tree__i_angle_bl"><span class="b-tree__i_angle_bl_inner"></span></span><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="img/i/null.gif" /></span></span>',
		html_render_folder_expander_angle_tl_tb_cached: '<span class="b-tree__spacer"><span class="b-tree__i_angle_tl"><span class="b-tree__i_angle_tl_inner"></span></span><span class="b-tree__i_vLine_tb"><span class="b-tree__i_vLine_tb_inner"></span></span><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="img/i/null.gif" /></span></span>',
		html_render_folder_expander_doclose_cached: '<span class="b-tree__spacer"><span class="b-tree__i_expander_doClose"><img class="b-tree__i_expander_doClose_inner" alt="-" title="" src="img/i/null.gif" /></span></span>',
...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["Кассир","Информация о системе Кассир","Документация по API и интеграции","Часто задаваемые вопросы","Введение","О программе","Работа с программой","Введение","Общая информация","Пример подключения через API","Подключение с помощью API","Список терминов и сокращений","Пример кода подключения через API","Авторизация","Список мероприятий","Количество мероприятий","Статистика по мероприятию","Список товаров","Загрузка зала","Работа с заказом","Справочники","Личный кабинет","Виджет «Kassir:Касса»","Загрузка готового компонента","Отслеживание действий с залом","Отрисовка схемы зала вручную","Добавление места в корзину","Удаление билета из корзины","Получение информации о заказе","Получение информации о заказе с информацией о продуктах","Подтверждение заказа","Очистка текущего заказа","Добавление товара в корзину","Очистка товаров из заказа","Изменение количества товара в корзине","Удаление товара из корзины","Типы событий","Страны","Города","Места проведения","Типы мест проведения","Залы","Способы доставки","Способы оплаты","Валюты","Авторизация клиента","Регистрация клиента","Получение профиля клиента","Восстановление пароля","Использование виджета","Дополнительные настройки для полноценной работы кассы","Получение схемы зала","Обновление схемы зала"],
	DREX_NODE_LINKS: ["kassir.html","informatsiya_o_sisteme_kassir.html","dokumentatsiya_po_api_i_integratsii.html","chasto_zadavaemye_voprosy.html","vvedenie_1.html","o_programme.html","rabota_s_programmoj.html","vvedenie_2.html","obshchaya_informatsiya.html","primer_podklyucheniya_cherez_api.html","podklyuchenie_s_pomoshchyu_api.html","spisok_terminov_i_sokrashchenij.html","primer_koda_podklyucheniya_cherez_api.html","avtorizatsiya.html","spisok_meropriyatij.html","kolichestvo_meropriyatij.html","statistika_po_meropriyatiyu.html","spisok_tovarov.html","zagruzka_zala.html","rabota_s_zakazom.html","spravochniki.html","lichnyj_kabinet.html","vidzhet__kassir_kassa_.html","zagruzka_gotovogo_komponenta.html","otslezhivanie_dejstvij_s_zalom.html","otrisovka_skhemy_zala_vruchnuyu.html","dobavlenie_mesta_v_korzinu.html","udalenie_bileta_iz_korziny.html","poluchenie_informatsii_o_zakaze.html","poluchenie_informatsii_o_zakaze_s_informatsiej_o_produktakh.html","podtverzhdenie_zakaza.html","ochistka_tekushchego_zakaza.html","dobavlenie_tovara_v_korzinu.html","ochistka_tovarov_iz_zakaza.html","izmenenie_kolichestva_tovara_v_korzine.html","udalenie_tovara_iz_korziny.html","tipy_sobytij.html","strany.html","goroda.html","mesta_provedeniya.html","tipy_mest_provedeniya.html","zaly.html","sposoby_dostavki.html","sposoby_oplaty.html","valyuty.html","avtorizatsiya_klienta.html","registratsiya_klienta.html","poluchenie_profilya_klienta.html","vosstanovlenie_parolya.html","ispolzovanie_vidzheta.html","dopolnitelnye_nastrojki_dlya_polnotsennoj_raboty_kassy.html","poluchenie_skhemy_zala.html","obnovlenie_skhemy_zala.html"],
	DREX_NODE_CHILD_START: [1,4,7,12,12,12,12,12,12,12,13,23,23,23,23,23,23,23,23,26,36,45,49,51,51,51,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53],
	DREX_NODE_CHILD_END: [4,7,12,12,12,12,12,12,12,13,23,23,23,23,23,23,23,23,26,36,45,49,51,51,51,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53,53],
	DREX_MENU_TYPE: 2,
